...
- Performance_schema中查看统计信息
  ...
  ```mysql
  select * from performance_schema.table_io_waits_summary_by_index_usage where object_schema='dbname' and object_name='tablename' limit 10 ;
  ...
  详细参考[官网](https://dev.mysql.com/doc/refman/8.0/en/performance-schema.html)
