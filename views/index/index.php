...
$blogsType = ArrayHelper::map($blogs,'id','icon');
$blogs = ArrayHelper::index($blogs,'id');
$icon =  $blogs[$type]['icon'];
$bgcolor =  $blogs[$type]['bgcolor'];
?>
                ...
                <div class="source-navbar" _v-257b13ec="" _v-50254422="">
                    <div class="source-selector" _v-09d73f71="" _v-257b13ec="">
                        <div class="curr" _v-09d73f71="">
                            <img class="icon source-icon" _v-09d73f71="" src="<?php echo $icon;?>">
                            <div class="title" _v-09d73f71="" style="color: rgb(4, 74, 171);">
                                <?php
                                $selection = Yii::$app->request->get('type')?:1;
                                echo \yii\helpers\Html::dropDownList('type', $selection, ArrayHelper::map($blogs,'id','name'), ['class' => 'dropdownlist','onChange'=>"change()",'style'=>'border: none;']); ?>
                            </div>
